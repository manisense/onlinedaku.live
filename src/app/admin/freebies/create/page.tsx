...
export default function CreateFreebie() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (!response.ok) {
        throw new Error(data.error || 'Failed to create freebie');
      }
  ...
  return (
    <div className="p-6">
      <h1 className="text-2xl font-bold text-indigo-600 mb-6">Create New Freebie</h1>
